...
4.  Which US state has the second fewest COVID-19 hospitalizations in 2021? Use the column `total_adm_all_covid_confirmed_past_7days`\
...
5. Which week in 2021 had the highest number of hospitalizations in the country (across all states and territories)? Use the column `total_adm_all_covid_confirmed_past_7days`\
